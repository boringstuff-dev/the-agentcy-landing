...
export async function generateMetadata({
  ...
  const found = getSolutionItemBySlug(slug);
  const content = SOLUTION_PAGES[slug];
  if (!found || !content) {
    return { title: "Solution · The Agentcy" };
  }
        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-bold tracking-tight">
              Why most {item.label} burn out on content.
            </h2>
          </div>
      ...
      <section className="border-t border-white/5 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-bold tracking-tight">
              Built around how {item.label} actually work.
            </h2>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-white/60">
              Same flow that powers every persona on The Agentcy. Submit a brief, seven AI agents collaborate, and you approve before anything goes live.
            </p>
          </div>
      ...
      <section className="border-t border-white/5">
        <div className="max-w-5xl mx-auto px-6 py-24 text-center">
          ...
          <p className="mt-5 text-white/60 max-w-2xl mx-auto">
            Try The Agentcy free for 7 days. No credit card. No commitment. Just publish-ready content from day one.
          </p>
          <div className="mt-10 flex items-center justify-center gap-3 flex-wrap">
            <Link
              href="/#cta"
